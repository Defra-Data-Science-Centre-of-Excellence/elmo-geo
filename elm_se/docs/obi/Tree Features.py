...
trees_output_template = ( "dbfs:/mnt/lab/unrestricted/elm/elmo/"
...
features_output_template = ( "dbfs:/mnt/lab/unrestricted/elm/elmo/"
                "hrtrees/"
                "tree_features_{timestamp}.parquet"
            )
...
pTreesDF = get_parcel_tree_features(spark, 
                                    treesDF, 
                                    parcelsDF, 
                                    hrDF,
                                    wbDF,
