...
df["centerline"].plot(ax=df.plot(alpha=0.5), color="k")
df

# COMMAND ----------

df2 = (
    gpd.read_parquet("/dbfs/mnt/lab/restricted/ELM-Project/ods/elmo_geo-hedge_sjoin-2023_12_12.parquet/sindex=NY97")
    .set_crs(epsg=27700)
    .explode()
...
df4["centerline"].plot(ax=df4.plot(alpha=0.5), color="k")
df4
