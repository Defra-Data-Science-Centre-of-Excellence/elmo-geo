...
from cdap_geo.sedona import F, st_register, st_load, st_join, st_valid
...
df_out = (spark.read.parquet(f_gis)
...
pdf['double_counted0.75'] = .95 < (pdf['length_overlap0.75'] / pdf['length'])
pdf['double_counted4'] = .95 < (pdf['length_overlap4'] / pdf['length'])
pdf['double_counted12'] = .95 < (pdf['length_overlap12'] / pdf['length'])
...
pd.DataFrame({
  ...
  'double counted': [f'{pdf["double_counted0.75"].mean():.1%}', f'{pdf["double_counted4"].mean():.1%}', f'{pdf["double_counted12"].mean():.1%}'],
  'adj hedgerows': [f'{dm1:,.0f} m', f'{dm4:,.0f} m', f'{dm12:,.0f} m'],
  '110%(1984)-2022': [f'{1.1*target-dm1:,.0f} m', f'{1.1*target-dm4:,.0f} m', f'{1.1*target-dm12:,.0f} m'],
