...
# MAGIC     - BTO habitats: this is used by the EVAST team to assign a habitat creation type to parcels. These in turn inform stocking densities on those parcels in the habitat creation scenario.
# MAGIC     - Grassland/heathland proximity: this is used by the FCP team to determine parcel eligibility for habitat creation/restoration actions.
# MAGIC
# MAGIC
