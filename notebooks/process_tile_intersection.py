...
conditions = [
    (pandas_df["proportion"] == 0),
    (pandas_df["proportion"] > 0) & (pandas_df["proportion"] <= 0.1),
    (pandas_df["proportion"] > 0.1) & (pandas_df["proportion"] <= 0.2),
    (pandas_df["proportion"] > 0.2) & (pandas_df["proportion"] <= 0.3),
    (pandas_df["proportion"] > 0.3) & (pandas_df["proportion"] <= 0.4),
    (pandas_df["proportion"] > 0.4) & (pandas_df["proportion"] <= 0.5),
    (pandas_df["proportion"] > 0.5) & (pandas_df["proportion"] <= 0.6),
    (pandas_df["proportion"] > 0.6) & (pandas_df["proportion"] <= 0.7),
    (pandas_df["proportion"] > 0.7) & (pandas_df["proportion"] <= 0.8),
    (pandas_df["proportion"] > 0.8) & (pandas_df["proportion"] <= 0.9),
    (pandas_df["proportion"] > 0.9) & (pandas_df["proportion"] < 1),
    (pandas_df["proportion"] == 1),
]
bin_values = [
    "0",
    "0-0.1",
...
pandas_df["proportion_groups"] = np.select(conditions, bin_values, default=0)
pandas_df.groupby(by="proportion_groups").count()
